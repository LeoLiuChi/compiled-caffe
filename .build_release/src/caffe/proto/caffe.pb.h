...
class LossParameter : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:caffe.LossParameter) */ {
 public:
  ...
  bool has_weight_by_label_freqs() const;
  void clear_weight_by_label_freqs();
  static const int kWeightByLabelFreqsFieldNumber = 3;
  bool weight_by_label_freqs() const;
  void set_weight_by_label_freqs(bool value);

  // repeated float class_weighting = 4;
  int class_weighting_size() const;
  void clear_class_weighting();
  static const int kClassWeightingFieldNumber = 4;
  float class_weighting(int index) const;
  void set_class_weighting(int index, float value);
  void add_class_weighting(float value);
  const ::google::protobuf::RepeatedField< float >&
...
class BNParameter : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:caffe.BNParameter) */ {
 public:
  ...
  static const BNMode LEARN =
    BNParameter_BNMode_LEARN;
  static const BNMode INFERENCE =
    BNParameter_BNMode_INFERENCE;
  ...
  bool has_bn_mode() const;
  void clear_bn_mode();
  static const int kBnModeFieldNumber = 3;
  ::caffe::BNParameter_BNMode bn_mode() const;
  void set_bn_mode(::caffe::BNParameter_BNMode value);
...
class DropoutParameter : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:caffe.DropoutParameter) */ {
 public:
  ...
  bool has_sample_weights_test() const;
  void clear_sample_weights_test();
  static const int kSampleWeightsTestFieldNumber = 2;
  bool sample_weights_test() const;
  void set_sample_weights_test(bool value);
...
class UpsampleParameter : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:caffe.UpsampleParameter) */ {
 public:
  ...
  ::google::protobuf::uint32 scale_h() const;
  void set_scale_h(::google::protobuf::uint32 value);

  // optional uint32 scale_w = 3;
  bool has_scale_w() const;
  void clear_scale_w();
  static const int kScaleWFieldNumber = 3;
  ::google::protobuf::uint32 scale_w() const;
  void set_scale_w(::google::protobuf::uint32 value);
  ...
  ::google::protobuf::uint32 upsample_h() const;
  void set_upsample_h(::google::protobuf::uint32 value);

  // optional uint32 upsample_w = 7;
  bool has_upsample_w() const;
  void clear_upsample_w();
  static const int kUpsampleWFieldNumber = 7;
  ::google::protobuf::uint32 upsample_w() const;
  void set_upsample_w(::google::protobuf::uint32 value);
